...
/// HOW TO RUN
///
/// --customerid <CustomerID> --productid <ProductID> --expiredate <ExpireDate> --customer_type <CustomerType>
///
/// Options:
...
///
/// % cargo run --bin serial_project_step5 -- --customerid 1234 --productid qwerasdf --expiredate 20250123 --customer_type 1
///     Finished `dev` profile [unoptimized + debuginfo] target(s) in 0.59s
///      Running `target/debug/serial_project_step5 --customerid 1234 --productid qwerasdf --expiredate 20250123 --customer_type 1`
/// serial.conf is found
/// Plain serial: 1234qwerasdf202501231
/// Encrypted serial: ad1s1CgctZ3UmcIo5WKnXzNLPY0nvaqxOmAZNxEWoDE=
/// Decrypted serial: 1234qwerasdf202501231
/// Verify CustomerID: 1234
/// Verify result: true
/// Verify ProductID: qwerasdf
/// Verify result: true
/// Verify ExpireDate: 20250123
/// Verify result: true
